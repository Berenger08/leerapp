...
const CATEGORIES = [
  ...
  {
    id: 'geneeskunde',
    label: 'Geneeskunde termen',
    storageKey: 'leerapp_geneeskunde_v1',
    seedItems: [
      { id: 'gen1', front: 'diagnose', back: 'het vaststellen van de aard van een ziekte op basis van symptomen en onderzoek.', example: 'De arts stelde na het bloedonderzoek de diagnose vast.' },
      { id: 'gen2', front: 'prognose', back: 'de verwachting over het waarschijnlijke verloop van een ziekte.', example: 'De prognose was gunstig dankzij de vroege behandeling.' },
      { id: 'gen3', front: 'symptoom', back: 'een merkbaar teken of verschijnsel dat wijst op een ziekte.', example: 'Koorts is een veelvoorkomend symptoom van een infectie.' },
      { id: 'gen4', front: 'chronisch', back: 'langdurig aanhoudend of steeds terugkerend, tegenover acuut.', example: 'Diabetes is een chronische aandoening.' },
      { id: 'gen5', front: 'acuut', back: 'plotseling optredend en vaak heftig, tegenover chronisch.', example: 'Hij kreeg een acute blindedarmontsteking.' },
      { id: 'gen6', front: 'benigne', back: 'goedaardig, niet kwaadaardig, vaak gezegd van een tumor.', example: 'Gelukkig bleek de tumor benigne te zijn.' },
      { id: 'gen7', front: 'maligne', back: 'kwaadaardig, vaak gezegd van een tumor of ziekte.', example: 'De biopsie toonde een maligne gezwel aan.' },
      { id: 'gen8', front: 'inflammatie', back: 'ontsteking, de reactie van het lichaam op weefselbeschadiging of infectie.', example: 'Roodheid en zwelling zijn tekenen van inflammatie.' },
      { id: 'gen9', front: 'hormoon', back: 'een signaalstof die door klieren wordt afgegeven en het lichaam via het bloed aanstuurt.', example: 'Insuline is een hormoon dat de bloedsuikerspiegel regelt.' },
      { id: 'gen10', front: 'antistof', back: 'een eiwit van het immuunsysteem dat een specifieke ziekteverwekker herkent en bestrijdt.', example: 'Na de infectie maakte het lichaam antistoffen aan.' },
      { id: 'gen11', front: 'pathogeen', back: 'een ziekteverwekker, zoals een virus of bacterie.', example: 'Het griepvirus is een veelvoorkomend pathogeen in de winter.' },
      { id: 'gen12', front: 'contra-indicatie', back: 'een reden om een bepaalde behandeling juist niet toe te passen.', example: 'Zwangerschap is een contra-indicatie voor dit medicijn.' },
      { id: 'gen13', front: 'atrofie', back: 'het krimpen of achteruitgaan van weefsel of een orgaan, bijvoorbeeld door gebrek aan gebruik.', example: 'Na lange tijd in het gips trad spieratrofie op.' },
      { id: 'gen14', front: 'hypertensie', back: 'te hoge bloeddruk.', example: 'Hypertensie verhoogt het risico op hart- en vaatziekten.' },
      { id: 'gen15', front: 'hypotensie', back: 'te lage bloeddruk.', example: 'Door de hypotensie werd ze duizelig bij het opstaan.' },
      { id: 'gen16', front: 'oedeem', back: 'vochtophoping in het weefsel, wat zwelling veroorzaakt.', example: 'Zijn enkel was gezwollen door oedeem.' },
      { id: 'gen17', front: 'anamnese', back: 'het gesprek waarin de arts de voorgeschiedenis en klachten van de patiënt in kaart brengt.', example: 'Tijdens de anamnese vroeg de arts naar eerdere klachten.' },
      { id: 'gen18', front: 'prevalentie', back: 'hoe vaak een ziekte in een bepaalde bevolkingsgroep voorkomt op een bepaald moment.', example: 'De prevalentie van de ziekte is hoger bij ouderen.' },
      { id: 'gen19', front: 'incidentie', back: 'het aantal nieuwe gevallen van een ziekte binnen een bepaalde periode.', example: 'De incidentie van griep stijgt elke winter.' },
      { id: 'gen20', front: 'palliatief', back: 'gericht op het verlichten van klachten in plaats van genezing, vaak in de laatste levensfase.', example: 'Hij kreeg palliatieve zorg om zijn pijn te verlichten.' },
      { id: 'gen21', front: 'resectie', back: 'het operatief verwijderen van (een deel van) een orgaan of weefsel.', example: 'Bij de operatie vond een resectie van de tumor plaats.' },
      { id: 'gen22', front: 'sepsis', back: 'een levensbedreigende reactie van het lichaam op een infectie, ook wel bloedvergiftiging genoemd.', example: 'Onbehandeld kan een infectie overgaan in sepsis.' },
      { id: 'gen23', front: 'comorbiditeit', back: 'het tegelijkertijd aanwezig zijn van meerdere ziekten of aandoeningen bij één patiënt.', example: 'Diabetes en hart- en vaatziekten komen vaak samen voor als comorbiditeit.' },
      { id: 'gen24', front: 'profylaxe', back: 'een voorzorgsmaatregel om een ziekte te voorkomen.', example: 'Hij kreeg antibiotica als profylaxe voor de operatie.' },
      { id: 'gen25', front: 'degeneratief', back: 'geleidelijk verslechterend van functie of structuur, vaak door veroudering of slijtage.', example: 'Artrose is een degeneratieve aandoening van de gewrichten.' },
    ],
  },
];
